<?php
	...
	$geocoder = new \OpenCage\Geocoder\Geocoder('2f81bf913ea2439d97298a1456018e3f');
	...
	if (in_array($result['status']['code'], [401,402,403,429])) {
		...
		foreach ($r['Response']['View'][0]['Result'] as $result) {
			...
			$temp['countryName'] = getCountryCode($result['Location']['Address']['CountryName']);
		...
		foreach ($result['results'] as $entry) {
			...
			$temp['countryName'] = strtoupper($entry['components']['country']);
